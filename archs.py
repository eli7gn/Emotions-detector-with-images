...
def vgg8(args):
    ...
    x = Dense(args.num_features, kernel_initializer='he_normal',
                kernel_regularizer=regularizers.l2(weight_decay))(x)
    x = BatchNormalization()(x)
    output = Dense(8, activation='softmax', kernel_regularizer=regularizers.l2(weight_decay))(x)
...
def vgg8_arcface(args):
    ...
    x = Dense(args.num_features, kernel_initializer='he_normal',
                kernel_regularizer=regularizers.l2(weight_decay))(x)
    x = BatchNormalization()(x)
    output = ArcFace(8, regularizer=regularizers.l2(weight_decay))([x, y])
...
def vgg8_cosface(args):
    ...
    x = Dense(args.num_features, kernel_initializer='he_normal',
                kernel_regularizer=regularizers.l2(weight_decay))(x)
    x = BatchNormalization()(x)
    output = CosFace(8, regularizer=regularizers.l2(weight_decay))([x, y])
...
def vgg8_sphereface(args):
    ...
    x = Dense(args.num_features, kernel_initializer='he_normal',
                kernel_regularizer=regularizers.l2(weight_decay))(x)
    x = BatchNormalization()(x)
    output = SphereFace(8, regularizer=regularizers.l2(weight_decay))([x, y])
